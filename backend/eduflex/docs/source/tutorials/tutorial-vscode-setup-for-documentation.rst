...
eduflex use restructured text (reST) and the `Sphinx` [#]_ documentation
build engine.
...
of `eduflex.code-workspace` and without any extensions.
...
.. code-block:: json

    {
        ...
        "settings": {
            ...
            "liveServer.settings.multiRootWorkspaceName": "eduflex",
            "[python]": {
