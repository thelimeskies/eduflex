        ...
        <div className="bg-gradient-to-r from-transparent via-gray-800/50 py-12 md:py-20">
          <div className="mx-auto max-w-3xl text-center">
            <h2
              ...
              data-aos="fade-up"
            >
              Simplify School Fee Payments with EduFlex
            </h2>
            <p
              ...
              data-aos-delay={200}
            >
              Empower parents and schools with affordable, low-interest loans and flexible payment plans. Start your journey with EduFlex today.
            </p>
