        ...
        <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,theme(colors.slate.400/.25),transparent)1] md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-4 text-center md:pb-12">
            ...
            <h2 className="animate-[gradient_6s_linear_infinite] bg-[linear-gradient(to_right,theme(colors.gray.200),theme(colors.indigo.200),theme(colors.gray.50),theme(colors.indigo.300),theme(colors.gray.200))] bg-[length:200%_auto] bg-clip-text pb-4 font-nacelle text-3xl font-semibold text-transparent md:text-4xl">
              Flexible Payments for Parents, Financial Stability for Schools
            </h2>
            <p className="text-lg text-indigo-200/65">
              EduFlex ensures parents can pay school fees flexibly while schools
              receive full payments upfront. Everyone wins.
            </p>
          </div>
          ...
          <div className="mx-auto grid max-w-sm gap-12 sm:max-w-none sm:grid-cols-2 md:gap-x-14 md:gap-y-16 lg:grid-cols-3">
            {/* Feature 1: Flexible Payment Plans */}
            <article>
              <svg
              ...
              <p className="text-indigo-200/65">
                Parents can choose weekly, bi-weekly, or monthly plans, ensuring
                education remains affordable.
              </p>
            </article>

            {/* Feature 2: Full Payment to Schools */}
            <article>
              <svg
                className="mb-3 fill-indigo-500"
                xmlns="http://www.w3.org/2000/svg"
              ...
              <h3 className="mb-1 font-nacelle text-[1rem] font-semibold text-gray-200">
                Full Fee Payments to Schools
              </h3>
              <p className="text-indigo-200/65">
                Schools receive 100% of the fees upfront while parents pay in
            ...
            <article>
              ...
              <p className="text-indigo-200/65">
                All financial transactions are secure and compliant with
                industry standards.
              </p>
            </article>
            ...
            <article>
              ...
              <p className="text-indigo-200/65">
                Schools and parents access clear, real-time reports on payments
                and loan usage.
              </p>
            </article>

            {/* Feature 5: Customizable Plans */}
            <article>
              <svg
                className="mb-3 fill-indigo-500"
                xmlns="http://www.w3.org/2000/svg"
              ...
              <p className="text-indigo-200/65">
                Tailored solutions for schools and parents to meet unique
                financial needs.
              </p>
            </article>
          </div>
