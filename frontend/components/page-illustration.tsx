...
import Image from "next/image";
// import EduFlexIllustration from "@/public/images/eduflex-illustration.svg";
// import EduFlexBlurredGray from "@/public/images/eduflex-blurred-shape-gray.svg";
// import EduFlexBlurred from "@/public/images/eduflex-blurred-shape.svg";
import Illustration from "@/public/images/page-illustration.svg";
import BlurredShapeGray from "@/public/images/blurred-shape-gray.svg";
import BlurredShape from "@/public/images/blurred-shape.svg";
export default function PageIllustration({
    ...
    <>
      ...
      >
        <Image
          ...
          width={846}
          height={594}
          alt="EduFlex illustration"
        />
      </div>
      {/* Optional multiple shapes */}
      {showMultiple && (
        <>
          <div
            className="pointer-events-none absolute left-1/2 top-[400px] -z-10 -mt-20 -translate-x-full opacity-50"
